package com.example.lbjfan.lbjfanmvpexample.view;
...
public class TabPageIndicator extends HorizontalScrollView {
    ...
    private int indicatorColor = Color.parseColor("#FF4081");//指示线的颜色  #0075E7
    ...
    private int scrollOffset = 20;// 当显示多个tab时，底部导航线距离左侧的位移,默认是10，请不要太小
...
//        isSameLine = a.getBoolean(R.styleable.PagerSlidingTab_sameLine, isSameLine);
        ...
        tabTextColor = a.getColor(R.styleable.PagerSlidingTab_tabUnSelectedColor, tabTextColor);
        tabTextColorSelected  =a.getColor(R.styleable.PagerSlidingTab_tabSelectedColor, tabTextColorSelected);
