...
import com.example.lbjfan.lbjfanmvpexample.utils.ImageLoadUtils;
...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private void setImageArray(Object[] imagesUrl, OnLoadImageListener imageListener) {
        ...
        for (int i = 0; i <= count + 1; i++) {
            ...
            GenericDraweeHierarchy gdh = GenericDraweeHierarchyBuilder.newInstance(context.getResources())
            ...
            if (imageListener != null) {
                ...
                if (defaultImage != -1)
                    ...
                    //ImageLoader.getInstance().displayImage(url.toString(), iv);
                    ImageLoadUtils.loadImageUrl(iv, url.toString());
                else {
